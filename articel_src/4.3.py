...
C13[(X < 350) | (X > 674)] = rho[(X < 350) | (X > 674)] * np.sqrt(
    (alpha2 ** 2 - beta2 ** 2) * ((1 + 2 * delta1) * alpha2 ** 2 - beta2 ** 2)) - rho[
                                 (X < 350) | (X > 674)] * beta2 ** 2
...
datax.save_bin("data/exp/4_3x.sfd")
dataz.save_bin("data/exp/4_3z.sfd")
